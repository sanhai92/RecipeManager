...
4. Push the source and a matching Git tag such as `v1.0.5`.
...
After GitHub Actions finishes, installed users can click **Check for updates** and should see version `1.0.5`.
